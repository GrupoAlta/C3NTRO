    ...
    <div>
      <nav className="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent">
        <div className="container">
          <a className="navbar-brand font-weight-bold d-none d-md-block" href=" https://demos.creative-tim.com/material-kit-pro/index " rel="tooltip" title="Designed and Coded by Creative Tim" data-placement="bottom" target="_blank">
            Material Kit 3 PRO
          </a>
          <a className="navbar-brand font-weight-bold d-block d-md-none" href=" https://demos.creative-tim.com/material-kit-pro/index " rel="tooltip" title="Designed and Coded by Creative Tim" data-placement="bottom" target="_blank">
            Material Design
          </a>
          <a href="https://www.creative-tim.com/product/material-kit-pro#pricingCard" className="btn btn-sm  bg-gradient-dark  mb-0 ms-auto d-lg-none d-block">Buy Now</a>
          ...
          <div className="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
            <ul className="navbar-nav navbar-nav-hover ms-auto">
              <li className="nav-item dropdown dropdown-hover mx-2">
                <a className="nav-link ps-2 d-flex cursor-pointer align-items-center" id="dropdownMenuPages6" data-bs-toggle="dropdown" aria-expanded="false" role="button">
                  <i className="material-symbols-rounded opacity-6 me-2 text-md">dashboard</i>
                  Pages
                  <img src="../../assets/img/down-arrow-dark.svg" alt="down-arrow" className="arrow ms-auto ms-md-2"/>
                </a>
                <div className="dropdown-menu ms-n3 dropdown-menu-animation dropdown-xl p-3 border-radius-xl mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages6">
              ...
              <li className="nav-item dropdown dropdown-hover mx-2">
                <a className="nav-link ps-2 d-flex cursor-pointer align-items-center" id="dropdownMenuAccount" data-bs-toggle="dropdown" aria-expanded="false" role="button">
                  <i className="material-symbols-rounded opacity-6 me-2 text-md">contacts</i>
                  Account
                  <img src="../../assets/img/down-arrow-dark.svg" alt="down-arrow" className="arrow ms-auto ms-md-2"/>
                </a>
                <div className="dropdown-menu dropdown-menu-animation dropdown-md border-radius-xl p-3 mt-0 mt-lg-3" aria-labelledby="dropdownMenuAccount">
                  <div className="d-none d-lg-flex">
                    <ul className="list-group w-100">
                      <li className="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                        <a className="dropdown-item border-radius-md text-dark ps-3 d-flex align-items-center mb-1" id="dropdownSignIn">
                          <span>Sign In</span>
                          <img src="../../assets/img/down-arrow.svg" alt="down-arrow" className="arrow ms-auto"/>
                        </a>
                      ...
                      <li className="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                        <a className="dropdown-item border-radius-md text-dark ps-3 d-flex align-items-center mb-1" id="dropdownSignUp">
                          <span>Sign Up</span>
                          <img src="../../assets/img/down-arrow.svg" alt="down-arrow" className="arrow ms-auto"/>
                        </a>
                      ...
                      <li className="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                        <a className="dropdown-item border-radius-md text-dark ps-3 d-flex align-items-center mb-1" id="dropdownPasswordReset">
                      ...
                      <li className="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                        <a className="dropdown-item border-radius-md text-dark ps-3 d-flex align-items-center mb-1" id="dropdownError">
                      ...
                      <li className="nav-item list-group-item border-0 p-0">
                        <a href="../../pages/coming-soon.html" className="dropdown-item border-radius-md text-dark ps-3 d-flex align-items-center mb-1">
                          <span>Coming Soon</span>
                        </a>
                      </li>
                      <li className="nav-item list-group-item border-0 p-0">
                        <a href="../../pages/2fa-security.html" className="dropdown-item border-radius-md text-dark ps-3 d-flex align-items-center mb-1">
              ...
              <li className="nav-item dropdown dropdown-hover mx-2">
                <a className="nav-link ps-2 d-flex cursor-pointer align-items-center" id="dropdownMenuBlocks" data-bs-toggle="dropdown" aria-expanded="false" role="button">
                  <i className="material-symbols-rounded opacity-6 me-2 text-md">view_day</i>
                  Sections
                  <img src="../../assets/img/down-arrow-dark.svg" alt="down-arrow" className="arrow ms-auto ms-md-2"/>
                </a>
                <div className="dropdown-menu dropdown-menu-end dropdown-menu-animation dropdown-md dropdown-md-responsive p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuBlocks">
                  <div className="d-none d-lg-block">
                    <ul className="list-group">
                      <li className="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                        <a className="dropdown-item py-2 ps-3 border-radius-md" href="../../index.html">
              ...
              <li className="nav-item dropdown dropdown-hover mx-2">
                <a className="nav-link ps-2 d-flex cursor-pointer align-items-center" id="dropdownMenuDocs" data-bs-toggle="dropdown" aria-expanded="false" role="button">
                  <i className="material-symbols-rounded opacity-6 me-2 text-md">article</i>
                  Docs
                  <img src="../../assets/img/down-arrow-dark.svg" alt="down-arrow" className="arrow ms-auto ms-md-2"/>
                </a>
                <div className="dropdown-menu dropdown-menu-end dropdown-menu-animation dropdown-md mt-0 mt-lg-3 p-3 border-radius-lg" aria-labelledby="dropdownMenuDocs">
                  <div className="d-none d-lg-block">
                    <ul className="list-group">
                      <li className="nav-item list-group-item border-0 p-0">
            ...
            <ul className="navbar-nav d-lg-block d-none">
              <li className="nav-item">
                <a href="https://www.creative-tim.com/product/material-kit-pro#pricingCard" className="btn btn-sm  bg-gradient-dark  mb-0 me-1">Buy Now</a>
              </li>
            </ul>
          </div>
        </div>
